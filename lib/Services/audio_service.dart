...
// 기존 코드
    recommend = Hive.box('settings').get('autoplay', defaultValue: true) as bool? ?? true;
    loadStart = Hive.box('settings').get('loadStart', defaultValue: true) as bool? ?? true;
          ...
          Future.delayed(const Duration(seconds: 1), () async {
            ...
            if (item == mediaItem.value) {
              try {
                ...
                print('Error while fetching recommendations: $e');
              }
            }
          });
        }
