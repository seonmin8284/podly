...
import 'package:podly/CustomWidgets/animated_text.dart';
import 'package:podly/CustomWidgets/copy_clipboard.dart';
import 'package:podly/CustomWidgets/download_button.dart';
import 'package:podly/CustomWidgets/empty_screen.dart';
import 'package:podly/CustomWidgets/equalizer.dart';
import 'package:podly/CustomWidgets/like_button.dart';
import 'package:podly/CustomWidgets/popup.dart';
import 'package:podly/CustomWidgets/seek_bar.dart';
...
import 'package:podly/Helpers/dominant_color.dart';
import 'package:podly/Helpers/lyrics.dart';
...
class _PlayScreenState extends State<PlayScreen> {
  ...
  Future<void> sleepTimer(int time) async {
    await audioHandler.customAction('sleepTimer', {'time': time});
  }
  final String gradientType = Hive.box('settings')
      .get('gradientType', defaultValue: 'halfDark')
      .toString();
  final getLyricsOnline =
  Hive.box('settings').get('getLyricsOnline', defaultValue: true);

  List<MediaItem> globalQ = [];
  ...
  Future<void> updateNplay() async {
    ...
    await audioHandler.updateQueue(globalQ);
